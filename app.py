...
def render_main_dashboard():
    ...
    if not df.empty:
        ...
        with tab2:
            ...
            with c_room: selected_room = st.selectbox("CHOOSE A ROOM:", all_rooms, index=st.session_state.kiosk_idx if st.session_state.get('autopilot', False) else 0, disabled=st.session_state.get('autopilot', False))
